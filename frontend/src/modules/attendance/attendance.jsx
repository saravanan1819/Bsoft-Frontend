...
export default function AttendancePage() {
  ...
  // Filter attendance records based on selected filter pill tab
                ...
                return (
                  <tr key={item.id} className="hover:bg-[#F9FAFB]/60 transition-colors text-[14px]">
                    ...
                    <td className="py-[14px] px-[20px] align-middle text-right pr-[28px]">
                      <span
                        className={`inline-block px-[14px] py-[4px] rounded-[8px] text-[13px] font-medium text-center ${
                          isPresent
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-[12px] pt-[4px]">
        ...
        <div className="flex items-center gap-[6px]">
          <button
            ...
            className="w-[32px] h-[32px] rounded-[8px] border-[0.5px] border-[#B9BEC7] bg-white flex items-center justify-center text-[#4B5563] hover:bg-[#F9FAFB] cursor-pointer"
          >
            <img src={Icons.previous} alt="Prev" className="w-[12px] h-[12px]" />
          </button>
          <button className="w-[32px] h-[32px] rounded-[8px] border-[0.5px] border-[#B9BEC7] bg-[#F3F4F6] flex items-center justify-center text-[13px] font-medium text-[#111827]">
            1
          </button>
          <button className="w-[32px] h-[32px] rounded-[8px] border-[0.5px] border-transparent bg-white flex items-center justify-center text-[13px] font-medium text-[#4B5563] hover:bg-[#F9FAFB]">
            2
          </button>
          <button className="w-[32px] h-[32px] rounded-[8px] border-[0.5px] border-transparent bg-white flex items-center justify-center text-[13px] font-medium text-[#4B5563] hover:bg-[#F9FAFB]">
            3
          </button>
          <span className="text-[13px] text-[#9CA3AF] px-[2px]">...</span>
          <button className="w-[32px] h-[32px] rounded-[8px] border-[0.5px] border-transparent bg-white flex items-center justify-center text-[13px] font-medium text-[#4B5563] hover:bg-[#F9FAFB]">
            8
          </button>
          <button
